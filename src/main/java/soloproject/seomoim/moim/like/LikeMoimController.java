...
public class LikeMoimController {
    ...
    public ResponseEntity<MoimDto.Response> postLike(@PathVariable("moim-Id") Long moimId,
    ...
    public ResponseEntity<MoimDto.Response> deleteLike(@PathVariable("moim-Id") Long moimId,
                                     @PathVariable("member-Id") Long memberId) {
